...
const HUMOR = {
    ...
    zeev: {
        ...
        emoji: '🐺',
        openingPopup: [
            { emoji: '🐺', text: 'זאביק הגיע! מקווה שהחופשה תהיה טובה יותר מהחיים' },
            { emoji: '📰', text: 'Wolf The Journalist! מוכן לכתוב כתבה על החופשה?' },
            { emoji: '🐺', text: 'זאב! הפעם המחירים לא ינצחו אותך' },
            { emoji: '💀', text: 'זאביק! בא לתכנן חופשה או להתלונן עליה?' },
            { emoji: '🎭', text: 'Breaking News: זאב הולך לחופשה ובטוח יתלונן' },
            { emoji: '🐺', text: 'יאללה נראה מי ינצח - אתה או המחירים' },
            { emoji: '📰', text: 'הזאב בשטח! סקופ: מישהו יוצא מהבית' },
            { emoji: '🎤', text: 'זאביק בסטודיו! היום: תחקיר על מחירי חופשות' }
        ],
        overBudget: [
            'זאב, התקציב ניצח אותך. כרגיל. מפתיע.',
            'חרגת! אבל אתה רגיל לזה',
            'התקציב עשה לך את מה שכולם עושים לך',
            'התקציב בדיוק אמר "ניצחתי את זאב"',
            'Breaking: זאב הפסיד שוב! הפעם לתקציב',
            'אווווו! צעקת הזאב המופתע נשמעת ברחבי הארץ'
        ],
        underBudget: [
            'וואו! הפעם אתה ניצחת את התקציב!',
            'לא יאומן! משהו לא הביס אותך!',
            'Breaking News: זאב ניצח! פעם ראשונה בהיסטוריה',
            'הזאב ניצח! התקציב בוכה בפינה',
            'יום היסטורי! זאב - 1, עולם - 4,582',
            'ג׳קפוט! בפעם הראשונה לא הפסדת זאביק'
        ],
        share: [
            'זאב שולח! סוף סוף הוא מפיץ משהו חיובי',
            'Exclusive: זאביק מפיץ משהו שזה לא תלונה',
            'עוד 5 דקות הוא יתלונן על משהו',
            'זאב מפיץ חלומות על חופשה שתתממש',
            'שיתף! נו, עכשיו החברים יקנאו במחירים'
        ],
        expensiveFlight: [
            'המחיר הזה? כן... קצת הגזימו',
            'טיסה כזו יקרה? הם חושבים שאתה עשיר',
            'חברת התעופה כבר שמחה - יש להם לקוח חדש',
            'הזמנת במחיר הזה? בהצלחה להתלונן אחר כך'
        ],
        rateUp: [
            'השער עלה! לא נעים, זאביק.',
            'הדולר עולה כמו תמיד',
            'אמריקה מתייקרת שוב',
            'השער עלה! נו, זה קורה'
        ],
        soloTrip: [
            'נוסע אחד? חופשה של שקט וכתיבה!',
            'לבד? יותר זמן לסקופים',
            'Wolf בסולו! כתבה עצמאית על חופשה אמיתית',
            'טס לבד? לפחות לא תצטרך לשתף את התלונות'
        ],
        // === פירגונים לזאב ===
        compliments: [
            'זאביק! אתה העיתונאי הכי מוכשר בישראל! 🐺🔥',
            'Wolf! אתה כותב כתבות שמרתקות את כולם!',
            'זאב, אתה כזה אלוף שאפילו הבוסים מקנאים!',
            'הזאביק הכי חתיך! אפילו הדולר עולה כשהוא רואה אותך!',
            'Wolf The Journalist! עיתונאי מבריק עם עתיד מבריק!',
            'זאב, יש לך את העט הכי חד בתעשייה!',
            'הזאב! כשאתה מראיין, כולם מקשיבים!',
            'זאביק, אתה כותב כתבות בתשוקה אמיתית!',
            'Wolf! הסקופ הכי חם זה אתה!',
            'זאב, הכישרון שלך שווה יותר מכל הציוד בערוץ!',
            'הזאביק! אם היית מניה, כולם היו משקיעים!',
            'זאב, אתה כזה מקצוען שכולם רוצים ראיון איתך!',
            'Wolf The Legend! אגדה בכתיבה!',
            'זאביק, הכתבות שלך עושות יותר רייטינג מכל התוכניות!',
            'הזאב! עם הכריזמה הזו? אתה חבילה מושלמת!',
            'זאב, כשאתה מדבר כולם מקשיבים!',
            'Wolf! אתה הסקופ של החיים שלנו!',
            'זאביק, אם הייתי כתבה - הייתי רוצה שתכתוב אותי!',
            'הזאב הגדול! גדול בעט, גדול בלב!',
            'זאב, אתה כזה אלפא שזאבים אחרים לומדים ממך!',
            'Wolf The Star! עיתונאי ביום, כוכב תמיד!',
            'זאביק, הידיים שלך כותבות כתבות שמשנות עולמות!',
            'הזאב! אתה מנצח את התעשייה!',
            'זאב, אתה יכול לעשות ראיונות עומק מטורפים!',
            'Wolf, שיהיה לך חופשה כמו סקופ - בלעדית וחמה! 🐺🔥'
        ]
    },
    ...
    amir: {
        ...
        // === פירגונים לאמיר ===
        compliments: [
            'אמיר המלך! אתה יכול לכבוש ממלכות! 👑',
            'אמיר, אתה כזה חתיך שהגבינה נמסה מעצמה ב-3 בלילה',
            'המלך! הבנות בחו"ל ירצו את האוכל של הדודה... ואותך',
            'אמיר, התיאבון שלך גדול כמו האישיות שלך - ענק!',
            'אתה כזה מגניב שגם הירוק נהיה יותר ירוק לידך',
            'אמיר, עם הסטייל הזה הדודה צריכה להתגאות!',
            'המלך אמיר! אתה גדול כמו המנות של הדודה!',
            'אמיר, אתה גבר שגורם לכולם לקום ב-3 בלילה!',
            'אתה כזה אלוף שהדודה צריכה להתגאות! בן יקר!',
            'אמיר, מי צריך גבינה כשיש את האישיות הזו שלך? 🧀',
            'המלך! עם הכריזמה שלך אתה יכול לפתוח עסק מצליח!',
            'אמיר, אתה כזה מלך שגם בלי ירוק אתה גורם לאופוריה',
            'הדודה יודעת שגידלה כוכב!',
            'אמיר, כולם רוצים להכיר אותך!',
            'אתה כזה חתיך שהמקרר נפתח לבד כשאתה מתקרב',
            'אמיר, מגיע לך חופשה - עבדת קשה!',
            'המלך! אתה גורם לכל החדר להרגיש טוב!',
            'אמיר, עם האנרגיה הזו הדודה גאה בך!',
            'אתה כזה מגניב שאפילו הגבינה הצהובה מסמיקה',
            'אמיר, אתה החבר הכי טוב שיש! 😏',
            'המלך! אתה כוכב אמיתי!',
            'אמיר, אתה כזה גבר שכולם רוצים להיות איתך!',
            'אתה מגיע לחופשה מושלמת!',
            'אמיר, אישיות של מלך עם לב של זהב!',
            'המלך! שיהיה לך חופשה מלאה בכיף ובמאנצ\'ס! 👑'
        ],
        meals: [
    ...
    boris: {
        ...
        // === פירגונים לבוריס ===
        compliments: [
            'בוריס, אתה כזה גבר שמשי גאה בך! 🇷🇺',
            'נו דא, בוריס! אתה גדול כמו רוסיה - אינסופי!',
            'בוריס, אתה עובד שעות נוספות כי אתה אלוף!',
            'הרוסי הכי מגניב מחוץ לרוסיה! משי בת מזל',
            'בוריס, הגזים שלך אולי חזקים אבל הלב שלך יותר גדול!',
            'נו דא, איזה גבר! משי מחזיקה אותך בסיבה טובה',
            'בוריס, עם הכוח הזה אתה יכול לעבוד עד סיביר!',
            'אתה כזה גבר שאפילו פוטין מקנא בעבודה הקשה שלך!',
            'בוריס, השעות הנוספות עשו לך שרירים של ברזל!',
            'הרוסי הכי חם בישראל! משי יודעת לבחור',
            'בוריס, מי צריך וודקה כשיש את האנרגיה הזו?',
            'נו דא, איזה גבר! האומץ שלך גדול מול כולם!',
            'בוריס, אתה מצחיק ואיש משפחה מדהים! 😂',
            'אתה כזה עובד קשה - גם בחיים, נכון בוריס?',
            'בוריס, משי גאה בך! יש לה גבר אמיתי!',
            'הרוסי עם הלב הכי גדול במזרח התיכון! לחיים!',
            'בוריס, מגיע לך חופשה - עבדת הרבה שעות נוספות!',
            'נו דא, אתה כזה כוכב של המשפחה!',
            'בוריס, אתה אלוף! משי יודעת איזה גבר יש לה',
            'עם הכוח הרוסי הזה אתה יכול לכבוש כל אתגר!',
            'בוריס, אתה עובד קשה ומשקיע במשפחה! כל הכבוד',
            'נו דא, האישיות שלך גדולה כמו מדינה!',
            'בוריס, משי מתגאה בך בפני כולם!',
            'אתה כזה גבר שהחופשה הזו הולכת להיות מדהימה!',
            'בוריס, שיהיה לך נופש כמו שעות נוספות - הרבה ומשתלם! 🔥'
        ],
        highBudget: [
    ...
    ishai: {
        ...
        // === פירגונים לישי ===
        compliments: [
            'ישי, אתה ביזנסמן אמיתי! 💼🔥',
            'Izzy The Businessman! עסקים מצוינים!',
            'ישי, אתה כזה גבר שכולם רוצים לעבוד איתך!',
            'עם הכריזמה הזו אתה יכול לסגור כל עסקה, ישי!',
            'ישי, אתה בוס אמיתי בכל תחום!',
            'Izzy, הביטחון שלך גדול כמו העסקאות שלך!',
            'ישי, אנשים מתלוננים על הדעות, אבל מעריכים את ההצלחה!',
            'אתה כזה ביזנסמן מוכשר שהמניות שלך תמיד עולות!',
            'ישי, אתה CEO של החיים שלך!',
            'Izzy The Winner? יותר כמו Izzy The Champion!',
            'ישי, הדעות שלך שנויות במחלוקת אבל ההצלחה לא!',
            'אתה כזה מנהיג שכולם הולכים אחריך!',
            'ישי, אתה עובד קשה כמו בוריס בשעות נוספות!',
            'עם הביזנס הזה, מי צריך לוטו?',
            'ישי, ביזנסמן עם לב של זהב!',
            'Izzy, אתה כזה גבר שכולם רוצים להיות שותפים שלך!',
            'ישי, מגיע לך חופשה אחרי כל ההצלחות!',
            'אתה חתיכת ביזנסמן מוצלח!',
            'ישי, הביטחון שלך מדבק את כולם!',
            'עם הראש הזה אתה יכול לפתוח חברת הייטק!',
            'ישי, אתה כזה גבר שהתקרה של הזכוכית נשברת בשבילך!',
            'Izzy, ההצלחה שלך היא ה-USP שלך!',
            'ישי, אתה אולי ישיר, אבל אנחנו אוהבים אותך!',
            'עם הכישרון הזה, מי צריך מזל?',
            'ישי, שיהיה לך נופש כמו ביזנס - מצליח ומשתלם! 💼🔥'
        ],
        femalePartner: [
