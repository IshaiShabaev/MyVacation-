...
const HUMOR = {
    ...
    zeev: {
        ...
        // === פירגונים לזאב ===
        compliments: [
            'זאביק, אתה הזאב הכי סקסי בלהקה! 🐺🔥',
            'זאב, עם הזין שלך אתה יכול לכתוב כתבות עומדות!',
            'Wolf! הציפור שלך גדולה כמו הסקופים שלך',
            'זאביק, אתה כזה חתיך שאפילו התקציב רוצה שתזיין אותו',
            'זאב, הבנות בחו"ל לא מוכנות לזין הישראלי שלך!',
            'וואלה זאביק, אתה כזה אלוף שאפילו הדולר עולה בשבילך',
            'זאב, אתה הכי! מי שזיין אותך פעם - מתגעגע',
            'זאביק, עם הכריזמה שלך אתה תזיין את כל החופשה!',
            'Wolf, אתה כזה גבר שאפילו חברות התעופה נרטבות',
            'זאב, מגיע לך חופשה - עבדת קשה עם האיבר הזה!',
            'זאביק, אתה חייב לקנות מכנסיים מיוחדים לזין הזה',
            'זאב, תאמין לי - מי שמזיין אותך עושה לעצמו טובה!',
            'Wolf, אתה עיתונאי עם עט גדול... אם אתה מבין למה אני מתכוון',
            'זאביק, אתה כזה מלך שמגיע לך הארמון הכי יקר!',
            'זאב, ידעת שאתה נראה כמו כוכב פורנו של עיתונאים?',
            'זאביק, הזין שלך צריך ויזה משלו - הוא גדול מדי!',
            'זאב, אתה ה-Alpha Wolf האמיתי! כל הזאבות רוצות אותך',
            'Wolf, עם הגוף הזה אתה יכול להיות כותרת ראשית!',
            'זאביק, מעולם לא ראיתי עיתונאי כזה חתיך ומסודר למטה',
            'זאב, תקציב גדול לגבר גדול! אתה שווה כל שקל',
            'זאביק, הביצים שלך גדולות כמו האומץ העיתונאי שלך!',
            'זאב, אתה כזה סטאליון שסוסים מקנאים בך',
            'Wolf, בחו"ל הבנות יתמוטטו מהאקסנט הישראלי והזין',
            'זאביק, אתה מכונת סקס עם תעודת עיתונאי!',
            'זאב, שיהיה לך חופשה מלאה בסקס כמו שמגיע לך!'
        ],
        overBudget: [
    ...
    amir: {
        ...
        // === פירגונים לאמיר ===
        compliments: [
            'אמיר! המלך עם הזין הכי גדול בממלכה! 👑🔥',
            'King Amir! כשאתה נכנס לחדר, הנשים שוכחות לנשום!',
            'אמיר, אתה אוכל גבינה בלילה כי אתה צריך אנרגיה לזין הזה!',
            'המלך! גדול בתיאבון, גדול באישיות, גדול... למטה!',
            'אמיר, הדודה מבשלת לך כי היא יודעת שאתה צריך כוח לביצועים!',
            'King! עם הירוק אתה נרגע, עם הזין אתה מרגש!',
            'אמיר, הגבינה בלילה? זה דלק לציוד המלכותי!',
            'המלך אמיר! כשאתה מחייך נשים נמסות כמו גבינה!',
            'אמיר, אתה כזה מלך שהדודה צריכה לבשל כפול!',
            'King Amir! השרביט שלך יותר מרשים מכל כתר!',
            'אמיר, אתה אוכל כמו מלך ומזיין כמו אל!',
            'המלך! עם התיאבון והזין הזה? חבילה מלכותית!',
            'אמיר, הבנות רוצות שתאכיל אותן גבינה... בלילה... פרטי!',
            'King! אתה הירוק הכי איכותי וגם הזין הכי איכותי!',
            'אמיר, המקרר רועד כשאתה קרב - והנשים גם!',
            'המלך אמיר! מה שיש לך למטה שווה יותר מכתר!',
            'אמיר, אתה סקסי כמו הארוחות של הדודה - מושקע!',
            'King! אם הזין היה מטבע, שלך היה זהב!',
            'אמיר, עם הציוד הזה אתה לא צריך ירוק להרגיש טוב!',
            'המלך! גדול בחיים, גדול באישיות, גדול בכל!',
            'אמיר, הדודה גאה בך - גם בבישול וגם... במה שלמדת לבד!',
            'King Amir! מלך בקולינריה ומלך במיטה!',
            'אמיר, אתה כזה מלך שהגבינה מתכבדת להיאכל!',
            'המלך! עם הכריזמה שלך וה... מתנה מלמטה? מושלם!',
            'אמיר, שיהיה לך סקס כמו ארוחה של הדודה - עשיר ומספק! 👑🔥'
        ]
    },
    ...
    boris: {
        ...
        // === פירגונים לבוריס ===
        compliments: [
            'בוריס! הרוסי עם הזין הכי גדול מערבית לאורל! 🇷🇺🔥',
            'Boris The Beast! עובד שעות נוספות ומזיין שעות נוספות!',
            'בוריס, אתה כזה גבר שמשי לא יכולה בלעדיך!',
            'הרוסי הגדול! גדול בעבודה, גדול במיטה, גדול בכל!',
            'בוריס, הגזים שלך אולי חזקים אבל הזין יותר חזק!',
            'Boris! אם הזין היה וודקה, שלך היה פרימיום!',
            'בוריס, משי נשארת איתך לא בגלל הכסף - בגלל הציוד!',
            'הרוסי! עם הזין הזה אתה יכול לכבוש אימפריות!',
            'בוריס, אתה עובד קשה כי הזין צריך תחזוקה יקרה!',
            'Boris The Machine! מכונה בעבודה, מכונה במיטה!',
            'בוריס, השעות הנוספות שלך בונות אימפריה של סקס!',
            'הרוסי הגדול! אתה קר כמו סיביר וחם כמו... הזין שלך!',
            'בוריס, עם הציוד הזה אתה שווה כל שעה נוספת!',
            'Boris! גוף של דוב רוסי, זין של סוס!',
            'בוריס, משי גאה בך - אתה עובד קשה ומזיין קשה!',
            'הרוסי! אם היית נשק ביולוגי, הייתת נשק של אהבה!',
            'בוריס, הוודקה שלך חזקה אבל הזין שלך יותר חזק!',
            'Boris The Stud! הסטאליון הרוסי של החבורה!',
            'בוריס, עם הזין הזה אתה לא צריך שעות נוספות - יש לך ביזנס פרטי!',
            'הרוסי הגדול! גדול בלב, גדול בנשמה, גדול... למטה!',
            'בוריס, אתה מסריח? לא משנה - עם הזין הזה הכל נסלח!',
            'Boris! אתה הסיבה שרוסיות עדיין מקנאות במשי!',
            'בוריס, אתה עובד כל כך קשה כי הזין דורש אורח חיים יקר!',
            'הרוסי! השרירים שלך מרשימים אבל מה שלמטה יותר מרשים!',
            'בוריס, שיהיה לך סקס כמו עבודה - מפרך ומתגמל! 🇷🇺🔥'
        ]
    },
...
let actionCounter = 0; // Counter for "every 4th action" logic
...
// Trigger humor on specific actions - EVERY 4TH ACTION shows joke
function triggerHumor(action, context = {}) {
    ...
    // Show joke every 4th action - guaranteed!
